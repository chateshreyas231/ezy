...
export const MOCK_BROKERS: MockBroker[] = [
    {
        ...
        tagline: "High-touch service for premium urban and luxury workflows.",
        foundedYear: 2008,
    ...
    },
    {
        ...
        tagline: "Commercial-first workflow for mixed-use, office, and income-producing assets.",
        foundedYear: 2006,
...
export const MOCK_VENDORS: MockVendor[] = [
    {
        ...
        reviews: [
            { name: "James Bond", role: "Agent", rating: 5, comment: "Fast and detailed report helped us prepare confidently." },
    ...
    },
    {
        ...
        role: "vendor",
        avatar: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?auto=format&fit=crop&w=400&q=80",
        banner: "https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?auto=format&fit=crop&w=1400&q=80",
    ...
    },
    {
        ...
        category: "Legal",
        specialties: ["Title review", "Contract risk checks", "Commercial workflow support"],
        ...
        rating: 4.8,
        reviewCount: 192,
        bio: "Real estate document team delivering clean title, contract confidence, and reduced completion risk.",
        certifications: ["Texas Bar Real Estate Section"],
        languages: ["English", "Spanish"],
        portfolio: [
            {
                title: "Mixed-Use Acquisition Workflow Support",
                location: "Dallas, TX",
        ...
        reviews: [
            ...
            { name: "Jordan Lee", role: "Seller", rating: 4, comment: "Clear and practical advice throughout the process." },
        ],
    },
    {
        id: "vendor-6",
