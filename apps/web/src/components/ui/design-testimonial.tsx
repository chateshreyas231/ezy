                        ...
                        <div className="flex items-end justify-between">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                >
                                    ...
                                    />
                                    <ChevronLeft size={18} className="relative z-10 text-foreground group-hover:text-foreground/30 transition-colors" />
                                </motion.button>
                                ...
                                >
                                    <motion.div
                                        ...
                                        transition={{ duration: 0.3, ease: [0.22, 1, 0.36, 1] }}
                                    />
                                    <ChevronRight size={18} className="relative z-10 text-foreground group-hover:text-foreground/30 transition-colors" />
                                </motion.button>
                            </div>
                        </div>
                    </div>
