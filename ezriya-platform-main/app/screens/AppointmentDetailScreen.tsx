  ...
  return (
    <ScrollView style={{ flex: 1, padding: 20 }}>
      ...
      {appointment.qr_token && (
        <View style={{ marginBottom: 20, padding: 16, backgroundColor: '#fff', borderRadius: 8, borderWidth: 2, borderColor: '#007AFF' }}>
      ...
      <View style={{ marginBottom: 20 }}>
        ...
        {checkins.length > 0 ? (
          checkins.map((checkin) => (
            <View key={checkin.id} style={{ padding: 12, marginBottom: 8, backgroundColor: '#f9f9f9', borderRadius: 8 }}>
          ...
          <Text style={{ color: '#666' }}>No check-ins yet</Text>
        )}
      </View>
