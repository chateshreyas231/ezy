...
// Premium form for creating buyer need posts
...
export default function CreateBuyerNeedScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Success', 'Buyer need post created successfully!', [
    ...
    <SafeScreen scrollable>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Create Buyer Need</Text>
          <View style={{ width: 40 }} />
        </View>
        ...
        <AnimatedCard delay={0} style={styles.card}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.priceRow}>
              <View style={[styles.priceInput, { marginRight: Theme.spacing.sm }]}>
              ...
              <View style={[styles.priceInput, { marginLeft: Theme.spacing.sm }]}>
        ...
        <AnimatedButton
          title={saving ? 'Creating Post...' : 'Create Buyer Need'}
          onPress={handleSubmit}
          loading={saving}
          disabled={saving || !state || !priceMin || !priceMax}
          icon="add-circle"
