    ...
    <ScrollView style={{ flex: 1, padding: 20 }}>
      ...
      <View style={{ marginBottom: 16 }}>
        ...
        <TextInput
          ...
          style={{ borderWidth: 1, borderColor: Theme.colors.border, padding: 12, borderRadius: 8 }}
        />
      </View>
      ...
      {matchId && (
        <View style={{ marginBottom: 16, padding: 12, backgroundColor: Theme.colors.surface, borderRadius: 8 }}>
          <Text style={{ fontSize: 12, color: Theme.colors.textTertiary }}>Related Match: {matchId}</Text>
        </View>
      )}
